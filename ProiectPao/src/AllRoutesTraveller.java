...
public class AllRoutesTraveller extends Traveller{
    public AllRoutesTraveller(String name, String uniqueCode, String city) {
    ...
    public boolean canTravel(String toCity) {
        ...
        return manager.canReach(this.city,toCity);
    }
